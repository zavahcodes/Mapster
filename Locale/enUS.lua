...
L["POI Scale"] = true
L["Hide Quest Blobs"] = true
L["Hide the semi-transparent quest area blobs, but keep the numbered POI icons visible on the map."] = true
L["Quest Objectives"] = true
L["Reset FogClear Data"] = true
L["Scale"] = true
L["Scale of the big map."] = true
L["Scale of the minimized map."] = true
L["Scale of text elements (zone name, track quest, coordinates) in minimized mode."] = true
